...
socket.on('reporte_10', function (msg) {
			...
			columns        : [
				...
				},
				{
					...
					render        : function (data, type, row) {
						...
						return "<button type='button' class='btn btn-red btn-icon btn-icon-standalone btn-xs' onClick='window.location.href = \"/ReportStorage/"+$('#userId').val()+"/Reporte10/" + data + "\"'>" +
