...
socket.on('reporte_22', function (msg) {
			...
			columns        : [
				...
				},
				{
					...
					render        : function (data, type, row) {
						...
						return "<button type='button' class='btn btn-red btn-icon btn-icon-standalone btn-xs' onClick='window.location.href = \"/ReportStorage/"+$('#userId').val()+"/Reporte22/" + data + "\"'>" +
