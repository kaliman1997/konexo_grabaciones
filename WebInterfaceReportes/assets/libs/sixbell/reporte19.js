	...
	columns        : [
		{
			...
			render       : function (data, type, row) {
				return "&nbsp;&nbsp;&nbsp;&nbsp;<input id='" + data + "' onChange='addItem()' type='checkbox' value='" + data + "'>";
			},
			sTitle       : "",
			sWidth       : "20px",
			bSortable    : true,
...
socket.on('reporte_19', function (msg) {
			...
			columns        : [
				...
				},
				{
					...
					render        : function (data, type, row) {
						...
						return "<button type='button' class='btn btn-red btn-icon btn-icon-standalone btn-xs' onClick='window.location.href = \"/ReportStorage/"+$('#userId').val()+"/Reporte19/" + data + "\"'>" +
