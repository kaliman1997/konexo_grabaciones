...
var Reporte19  = {
	...
	createExcel : async function (excelData, optsParameter) {
		...
		ws.column(1).setWidth(47);
		ws.column(2).setWidth(63);
		ws.column(3).setWidth(23);
		ws.column(4).setWidth(14);
		ws.column(5).setWidth(14);
		ws.column(6).setWidth(25);
		ws.column(7).setWidth(20);
		ws.column(8).setWidth(36);
		ws.column(9).setWidth(17);
		ws.column(10).setWidth(31);
		ws.column(11).setWidth(24);
		ws.column(12).setWidth(23);
		ws.column(13).setWidth(26);
		ws.column(14).setWidth(26);
		ws.column(15).setWidth(37);
		ws.column(16).setWidth(36);
		ws.column(17).setWidth(21);
		ws.column(18).setWidth(31);

		ws.cell(5, 1).string("Nombre del agente").style(style).style(headerStyle);
		ws.cell(5, 2).string("Identificador de conexión").style(style).style(headerStyle);
		ws.cell(5, 3).string("Tiempo con personal").style(style).style(headerStyle);
		ws.cell(5, 4).string("Tiempo AUX").style(style).style(headerStyle);
		ws.cell(5, 5).string("Tiempo en 0").style(style).style(headerStyle);
		ws.cell(5, 6).string("Trabajo Administrativo").style(style).style(headerStyle);
		ws.cell(5, 7).string("Descanso/Comida").style(style).style(headerStyle);
		ws.cell(5, 8).string("Problemas de hardware/software").style(style).style(headerStyle);
		ws.cell(5, 9).string("Campaña/Chat").style(style).style(headerStyle);
		ws.cell(5, 10).string("Seguimiento a transacciones").style(style).style(headerStyle);
		ws.cell(5, 11).string("Coaching/Feedback").style(style).style(headerStyle);
		ws.cell(5, 12).string("Capacitación/Examen").style(style).style(headerStyle);
		ws.cell(5, 13).string("Término de jornada").style(style).style(headerStyle);
		ws.cell(5, 14).string("Consulta a Coordinador").style(style).style(headerStyle);
		ws.cell(5, 15).string("Consulta a Capital Humano/Atracc").style(style).style(headerStyle);
		ws.cell(5, 16).string("Acta administrativa/Carta compro").style(style).style(headerStyle);
		ws.cell(5, 17).string("Asistencia médica").style(style).style(headerStyle);
		ws.cell(5, 18).string("Medidas de higiene covid-19").style(style).style(headerStyle);
		...
		excelData.forEach((rowData, pointer) => {
			...
			ws.cell(initialRow, 1).string(rowData.agentName).style(style).style(align.left);
			ws.cell(initialRow, 2).string(rowData.locationID).style(style).style(align.left);
			ws.cell(initialRow, 3).number(Math.round(rowData.acdTime / 1000)).style(style).style(align.right);
			acdTime = acdTime + (Math.round(rowData.acdTime / 1000) || 0);
			ws.cell(initialRow, 4).number(Math.round(rowData.auxTime / 1000)).style(style).style(align.right);
			auxTime = auxTime + (Math.round(rowData.auxTime / 1000) || 0);
			ws.cell(initialRow, 5).number(Math.round(rowData.aux01 / 1000)).style(style).style(align.right);
			aux01 = aux01 + (Math.round(rowData.aux01 / 1000) || 0);
			ws.cell(initialRow, 6).number(Math.round(rowData.aux02 / 1000)).style(style).style(align.right);
			aux02 = aux02 + (Math.round(rowData.aux02 / 1000) || 0);
			ws.cell(initialRow, 7).number(Math.round(rowData.aux03 / 1000)).style(style).style(align.right);
			aux03 = aux03 + (Math.round(rowData.aux03 / 1000) || 0);
			ws.cell(initialRow, 8).number(Math.round(rowData.aux04 / 1000)).style(style).style(align.right);
			aux04 = aux04 + (Math.round(rowData.aux04 / 1000) || 0);
			ws.cell(initialRow, 9).number(Math.round(rowData.campain / 1000)).style(style).style(align.right);
			campain = campain + (Math.round(rowData.campain / 1000) || 0);
			ws.cell(initialRow, 10).number(Math.round(rowData.followup / 1000)).style(style).style(align.right);
			followup = followup + (Math.round(rowData.followup / 1000) || 0);
			ws.cell(initialRow, 11).number(Math.round(rowData.aux07 / 1000)).style(style).style(align.right);
			aux07 = aux07 + (Math.round(rowData.aux07 / 1000) || 0);
			ws.cell(initialRow, 12).number(Math.round(rowData.aux08 / 1000)).style(style).style(align.right);
			aux08 = aux08 + (Math.round(rowData.aux08 / 1000) || 0);
			ws.cell(initialRow, 13).number(Math.round(rowData.aux09 / 1000)).style(style).style(align.right);
			aux09 = aux09 + (Math.round(rowData.aux09 / 1000) || 0);
			ws.cell(initialRow, 14).number(Math.round(rowData.aux10 / 1000)).style(style).style(align.right);
			aux10 = aux10 + (Math.round(rowData.aux10 / 1000) || 0);
			ws.cell(initialRow, 15).number(Math.round(rowData.aux11 / 1000)).style(style).style(align.right);
			aux11 = aux11 + (Math.round(rowData.aux11 / 1000) || 0);
			ws.cell(initialRow, 16).number(Math.round(rowData.aux12 / 1000)).style(style).style(align.right);
			aux12 = aux12 + (Math.round(rowData.aux12 / 1000) || 0);
			ws.cell(initialRow, 17).number(Math.round(rowData.aux13 / 1000)).style(style).style(align.right);
			aux13 = aux13 + (Math.round(rowData.aux13 / 1000) || 0);
			ws.cell(initialRow, 18).number(Math.round(rowData.aux14 / 1000)).style(style).style(align.right);
		...
		ws.cell(6, 2).string("").style(style).style(align.left);
		ws.cell(6, 3).number(acdTime).style(style).style(align.right);
		ws.cell(6, 4).number(auxTime).style(style).style(align.right);
		ws.cell(6, 5).number(aux01).style(style).style(align.right);
		ws.cell(6, 6).number(aux02).style(style).style(align.right);
		ws.cell(6, 7).number(aux03).style(style).style(align.right);
		ws.cell(6, 8).number(aux04).style(style).style(align.right);
		ws.cell(6, 9).number(campain).style(style).style(align.right);
		ws.cell(6, 10).number(followup).style(style).style(align.right);
		ws.cell(6, 11).number(aux07).style(style).style(align.right);
		ws.cell(6, 12).number(aux08).style(style).style(align.right);
		ws.cell(6, 13).number(aux09).style(style).style(align.right);
		ws.cell(6, 14).number(aux10).style(style).style(align.right);
		ws.cell(6, 15).number(aux11).style(style).style(align.right);
		ws.cell(6, 16).number(aux12).style(style).style(align.right);
		ws.cell(6, 17).number(aux13).style(style).style(align.right);
		ws.cell(6, 18).number(aux14).style(style).style(align.right);
		...
		try {
			...
			if (optsParameter.crontab) {
				 ...
				 */
				let reportStorage = path.join(process.cwd(), "ReportStorage", optsParameter.ownerId, "Reporte19");
